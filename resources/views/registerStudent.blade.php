    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registerStudent.store') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-address text-md-right">{{ __('Residential Address') }}</label>
